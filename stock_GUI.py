...
# Author: Louie Venegas d41112084
# Date: 02/13/2024
...
class StockApp:
    def __init__(self):
        ...
        # Create Window
        self.root = Tk()
        self.root.title("Stock Manager LOUIE VENEGAS D41112084 CEIS150")
    ...
    def delete_stock(self):
        if (self.sotckList.curselection()):
            symbol = self.stockList.get(self.stockList.curseselection())
            i = 0
            for stock in self.stock_list:
                if stock.symbol == symbol:
